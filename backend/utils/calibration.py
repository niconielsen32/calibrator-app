...
def calibrate_camera(images_path, checkerboard_size, square_size, pattern_type, marker_size=None, aruco_dict_name=None, camera_model="Standard", optimize=False):
    """
    Calibrate camera using images from a directory.
